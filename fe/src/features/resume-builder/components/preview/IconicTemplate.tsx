...
import { iconicConfig } from "./shared/configs";
...
export function IconicTemplate({ editable = false }: IconicTemplateProps) {
  ...
  return (
    <div>
      {/* Header */}
      <div
        className="mb-5 rounded-lg border-2 px-5 py-4"
      ...
      <TemplateLayout setup={setup} config={iconicConfig} editable={editable} />
    </div>
  );
}
