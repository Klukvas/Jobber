...
import { timelineConfig } from "./shared/configs";
...
export function TimelineTemplate({ editable = false }: TimelineTemplateProps) {
  ...
  return (
    <div>
      {/* Header - clean layout with colored underline */}
      <div className="mb-5">
        <EditableField
