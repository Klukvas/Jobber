  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1080px]">
        ...
        <div ref={ref} className="relative grid gap-8 md:gap-0 md:grid-cols-4">
          {/* Connecting line draws in as the steps reveal */}
          <div
            className={cn(
              "landing-line-draw absolute top-5 left-[10%] right-[10%] hidden h-px bg-gradient-to-r from-transparent via-white/[0.07] to-transparent md:block",
              isInView && "is-visible",
            )}
          />
          ...
          {STEPS.map((step, i) => (
            <Reveal
              key={step}
              delayMs={i * 120}
              className="px-0 md:px-6 text-center"
            >
