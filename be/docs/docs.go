...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_andreypavlenko_jobber_modules_resumes_model.AutofillProfileDTO"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
                    ...
                    "403": {
                        "description": "PAID_FEATURE or PLAN_LIMIT_REACHED",
                        "schema": {
                            "$ref": "#/definitions/github_com_andreypavlenko_jobber_internal_platform_http.ErrorResponse"
                        }
                    },
                    ...
                    "422": {
                        "description": "Resume file unreadable or missing",
                        "schema": {
                            "$ref": "#/definitions/github_com_andreypavlenko_jobber_internal_platform_http.ErrorResponse"
                        }
                    },
    ...
    "definitions": {
        ...
        "github_com_andreypavlenko_jobber_modules_resumes_model.AutofillContactDTO": {
            "type": "object",
            "properties": {
                "email": {
                    "type": "string"
        ...
        "github_com_andreypavlenko_jobber_modules_resumes_model.AutofillEducationDTO": {
            "type": "object",
            "properties": {
                "degree": {
                    "type": "string"
        ...
        "github_com_andreypavlenko_jobber_modules_resumes_model.AutofillExperienceDTO": {
            "type": "object",
            "properties": {
                "company": {
                    "type": "string"
        ...
        "github_com_andreypavlenko_jobber_modules_resumes_model.AutofillProfileDTO": {
            "type": "object",
            "properties": {
                "contact": {
                    "$ref": "#/definitions/github_com_andreypavlenko_jobber_modules_resumes_model.AutofillContactDTO"
                },
                "educations": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_andreypavlenko_jobber_modules_resumes_model.AutofillEducationDTO"
                    }
                },
                "experiences": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_andreypavlenko_jobber_modules_resumes_model.AutofillExperienceDTO"
                    }
                },
                "skills": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_andreypavlenko_jobber_modules_resumes_model.AutofillSkillDTO"
                    }
                },
                "summary": {
                    "$ref": "#/definitions/github_com_andreypavlenko_jobber_modules_resumes_model.AutofillSummaryDTO"
                }
            }
        },
        "github_com_andreypavlenko_jobber_modules_resumes_model.AutofillSkillDTO": {
            "type": "object",
            "properties": {
                "level": {
                    "type": "string"
        ...
        "github_com_andreypavlenko_jobber_modules_resumes_model.AutofillSummaryDTO": {
            "type": "object",
            "properties": {
                "content": {
                    "type": "string"
